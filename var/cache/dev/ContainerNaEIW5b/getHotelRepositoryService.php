...
// Returns the private 'App\Repository\HotelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\HotelRepository.php';

return $this->privates['App\\Repository\\HotelRepository'] = new \App\Repository\HotelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
